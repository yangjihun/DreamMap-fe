...
export default function UploadPage() {
  ...
  if (isAnalyzing) {
    return (
      <>
        <Helmet>
          <title>분석 중... - ResumeAI</title>
          <meta name="description" content="AI가 레쥬메를 분석하고 있습니다. 잠시만 기다려주세요." />
        </Helmet>
  ...
  return (
    <>
      <Helmet>
        <title>레쥬메 업로드 - ResumeAI</title>
        <meta name="description" content="파일을 업로드하거나 직접 입력하여 AI 분석을 시작하세요" />
      </Helmet>
