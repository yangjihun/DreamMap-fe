...
import { Sparkles, User, ArrowRight, FileText, TrendingUp, Target, Award } from "lucide-react"
...
export default function HomePage() {
  return (
    <>
      <Helmet>
        <title>ResumeAI - 당신의 인생을 설계해드립니다</title>
        <meta name="description" content="AI가 분석하는 맞춤형 레쥬메로 IT 커리어의 새로운 장을 시작하세요" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-xl font-semibold text-gray-900">ResumeAI</h1>
              </div>
              <Link to="/login">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-16">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 mb-8">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">당신의 인생을 설계해드립니다</h2>
          ...
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">당신의 성장 여정</h3>
            <div className="grid md:grid-cols-4 gap-6">
              {/* 현재 */}
              <Card className="bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <CardContent className="p-6 text-center">
                  <div className="w-16 h-16 bg-gray-100 rounded-full mx-auto mb-4 flex items-center justify-center">
                    <img src="/current-situation-silhouette.png" alt="현재" className="w-12 h-12 rounded-full" />
                  </div>
                  <h4 className="font-semibold text-gray-900 mb-2">현재</h4>
                  <p className="text-sm text-gray-600">지금의 나, 새로운 시작점</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <CardContent className="p-6 text-center">
                  <div className="w-16 h-16 bg-blue-50 rounded-full mx-auto mb-4 flex items-center justify-center">
                    <img src="/placeholder-i3ogj.png" alt="3개월 후" className="w-12 h-12 rounded-full" />
                  </div>
              ...
              <Card className="bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <CardContent className="p-6 text-center">
                  <div className="w-16 h-16 bg-green-50 rounded-full mx-auto mb-4 flex items-center justify-center">
                    <img src="/confident-silhouette.png" alt="6개월 후" className="w-12 h-12 rounded-full" />
                  </div>
              ...
              <Card className="bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <CardContent className="p-6 text-center">
                  <div className="w-16 h-16 bg-purple-50 rounded-full mx-auto mb-4 flex items-center justify-center">
                    <img src="/placeholder-orapj.png" alt="1년 후" className="w-12 h-12 rounded-full" />
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="bg-white border border-gray-200 shadow-sm">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">AI 레쥬메 분석</h3>
                <p className="text-gray-600">최신 AI 기술로 레쥬메를 분석하고 개선점을 제안합니다</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border border-gray-200 shadow-sm">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">성장 로드맵</h3>
                <p className="text-gray-600">개인 맞춤형 커리어 성장 계획과 학습 경로를 제공합니다</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border border-gray-200 shadow-sm">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600">지역과 직무를 고려한 교육 프로그램과 스터디를 추천합니다</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              수천 명의 IT 전문가들이 ResumeAI와 함께 성공적인 커리어 전환을 이뤘습니다
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <span className="text-lg font-semibold text-gray-900">ResumeAI</span>
              </div>
